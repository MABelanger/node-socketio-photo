...
Par exemple, il est possible d'envoyer un POST à **mquartier.com/api/photos** de cette icon ![alt nasa icon](./nasa.gif) encodé en base64 à l'aide de la commande **Curl**:
...
Cette commande envoie une image gif au serveur 'mquartier.com' disponible sur : https://mquartier.com/screen/
